...
inline uString& uString::operator= (const char* str) {
    constructByType(str, strlen(str), Encoding_Default, mEncoding);
    return *this;
}
inline uString& uString::operator= (const wchar_t* str) {
    constructByType(str, mEncoding);
...
inline uString& uString::set(const char* str, Encoding en/* = Encoding_Default*/) {
    constructByType(str, strlen(str), en, mEncoding);
    return *this;
}
